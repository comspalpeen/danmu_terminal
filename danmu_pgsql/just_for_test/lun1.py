...
async def export_html():
    ...
    sql = """
        ...
        WHERE g.room_id = '7612898570093579027'
          AND g.send_time >= '2026-03-03 13:35:00'
          AND g.send_time < '2026-03-03 14:18:00'
    ...
    # 落盘保存
    filename = "chenze_gifts_report_mobile.html"
